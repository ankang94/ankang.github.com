...
![堵塞IO的类比图](assets/image/block_io.png)
...
![非堵塞 IO 类比图](assets/image/none_block_io.png)
...
![IO 多路复用类比时序图](assets/image/multi_io.png)
...
libuv的[官方文档](http://docs.libuv.org/en/v1.x/design.html)在阐述他的架构的时候给出来这么一张图![一张图](http://docs.libuv.org/en/v1.x/_assets/image/architecture.png)，但是仅仅凭着这么一张图并不能让你对其内部机制理解得更透彻。
...
![默认事件轮询流程图](assets/image/uv_run.png)  
**图1.2.1 默认事件轮询流程图**
